...
| **Fase 13** | **13A e 13B FECHADAS**. 13A: medição + correção de 5 campos lidos com nome/tipo errado (`medicoes/2026-09-04-13a-medicao.md`). 13B: a folha de calibração saiu da tela — host isolado, `.relatorio-preview` não é mais dependência do gerador (`medicoes/2026-09-04-13b-certificado-sem-dom.md`). 13C: os dois campos que a folha gravava (grade de espessuras e laudo) passaram a ser editados em React, com as MESMAS chaves, atrás da flag `nr13_edicao_react` (`medicoes/2026-09-04-13c-editor-react.md`). 13D aguarda autorização |
